...
/**
 * Transformer: USAA section breaks + Section Metadata.
 * Inserts <hr> boundaries and Section Metadata blocks from
 * payload.template.sections. Selectors come directly from
 * page-templates.json (each verified against migration-work/cleaned.html).
 *
 ...
 * afterTransform, anchored to a marker <hr> that survives parsing.
 */
